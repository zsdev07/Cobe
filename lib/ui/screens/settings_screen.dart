...
class _SettingsRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          Expanded(child: Text(label, style: const TextStyle(fontSize: 12, color: CobeTokens.dark.textPrimary))),
          const Icon(Icons.chevron_right_rounded, size: 16, color: CobeTokens.dark.textMuted),
        ],
      ),
    );
  }
