  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          SizedBox(width: 14, child: Text(prefix, style: TextStyle(color: CobeTokens.dark.textMuted, fontSize: 12))),
          Expanded(child: Text(line, style: TextStyle(fontSize: 12.5, color: CobeTokens.dark.textPrimary))),
        ],
      ),
    );
  }
