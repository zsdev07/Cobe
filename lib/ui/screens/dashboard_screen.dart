    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: CobeSpacing.md),
          Text('Projects', style: TextStyle(fontSize: 13, color: CobeTokens.dark.textMuted)),
                  ...
                  itemBuilder: (context, i) {
                    ...
                    return CobeSurface(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Icon(Icons.folder_open_rounded, size: 18, color: CobeTokens.dark.textPrimary),
                          const Spacer(),
                          Text(
                            project.name,
                            maxLines: 1,
                          ...
                          Text(
                            ...
                            maxLines: 2,
                            overflow: TextOverflow.ellipsis,
                            style: TextStyle(fontSize: 10.5, color: CobeTokens.dark.textMuted),
                          ),
                        ],
                      ),
                    );
